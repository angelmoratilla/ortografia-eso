...
### Progreso por módulo
Cada sesión tiene **10 ejercicios**. La meta por módulo son **5 tandas completadas** (50 ejercicios en total). La pantalla de inicio y el perfil muestran `X/5 tandas` y la barra de progreso llega al 100 % al alcanzar esa meta. Una vez superadas las 5 tandas el módulo aparece como "✅ Dominado" y se puede seguir practicando libremente.

### Selección progresiva de dificultad
Dentro de cada tanda de 10 ejercicios, la dificultad escala de forma automática:

| Posición | Dificultad | Cantidad |
|---|---|---|
| 1–4 | Fácil | 4 |
| 5–7 | Medio | 3 |
| 8–10 | Difícil | 3 |

Dentro de cada bloque el orden es aleatorio. Si un módulo tiene pocos ejercicios de algún nivel, los huecos se rellenan con ejercicios de otros niveles.
...
| 🏅 Módulo completado | Completar 5 tandas en un módulo |
...
|---|---|---|
| `utils.test.ts` | 16 | `shuffle`, `moduleProgressPercent`, `levelProgress`, `scoreColor`, `selectExercisesProgressive` |
